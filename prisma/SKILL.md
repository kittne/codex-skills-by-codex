...
- For Prisma ORM 7+, update imports from `@prisma/client` to your configured generated output path.
...
- Use `prisma.config.ts` to pin non-default schema, migrations, and seed paths in monorepos or custom layouts.
