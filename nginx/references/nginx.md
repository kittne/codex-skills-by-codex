...
name: nginx description: > Comprehensive, up-to-date guidance for secure and performant NGINX configurations (TLS, reverse proxy, caching, etc). Use for any task creating, updating, auditing, or troubleshooting NGINX setups to apply modern best practices.
________________________________________
